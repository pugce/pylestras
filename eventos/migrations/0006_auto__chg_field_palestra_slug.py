...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Palestra.slug'
        db.alter_column('eventos_palestra', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Palestra.slug'
        db.alter_column('eventos_palestra', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=100, null=True))
