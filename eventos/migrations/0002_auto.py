...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field patrocinadores on 'Evento'
        db.create_table('eventos_evento_patrocinadores', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('evento', models.ForeignKey(orm['eventos.evento'], null=False)),
            ('patrocinio', models.ForeignKey(orm['eventos.patrocinio'], null=False))
        ))
        db.create_unique('eventos_evento_patrocinadores', ['evento_id', 'patrocinio_id'])


    def backwards(self, orm):
        # Removing M2M table for field patrocinadores on 'Evento'
        db.delete_table('eventos_evento_patrocinadores')
